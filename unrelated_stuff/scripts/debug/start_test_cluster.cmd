...
IF NOT EXIST "%SCRIPT_PATH%..\syncthing.exe" echo [ERROR] You need to build syncthing.exe first. & goto :eof
copy /y "%SCRIPT_PATH%..\syncthing.exe" "%SCRIPT_PATH%syncthing-test.exe"
...
REM call :startSyncthingInstance Felix	8803	8813
REM call :startSyncthingInstance Kevin	8804	8814
REM call :startSyncthingInstance Mum		8805	8815
REM 
