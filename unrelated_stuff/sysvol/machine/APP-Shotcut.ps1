...
#
# Consts.
$binInstaller = Resolve-Path -ErrorAction Stop -Path ($PSScriptRoot + "\..\install\Shotcut\Shotcut_v24.01.28.msi")
$binInstallerArg = "/i `"$binInstaller`" /qb /norestart REBOOT=ReallySuppress"
$binInstalledVersionFile = $ENV:ProgramFiles + "\Shotcut\Shotcut.packageversion"
#
# Runtime Variables.
